...
export const LIBRARY = [
  /* ---------------------------------------------------------- foundation */
  { pack: 'foundation', title: 'Fajr on time', emoji: '\u{1F305}', category: 'worship', difficulty: 4,
  ...
  { pack: 'foundation', title: 'Dhuhr on time', emoji: '\u{2600}\u{FE0F}', category: 'worship', difficulty: 2,
  ...
  { pack: 'foundation', title: 'Asr on time', emoji: '\u{26C5}', category: 'worship', difficulty: 2,
  ...
  { pack: 'foundation', title: 'Maghrib on time', emoji: '\u{1F307}', category: 'worship', difficulty: 2,
  ...
  { pack: 'foundation', title: 'Isha on time', emoji: '\u{1F319}', category: 'worship', difficulty: 2,
  ...
  { pack: 'foundation', title: 'Sunnah rawatib', emoji: '\u{1F54B}', category: 'worship', difficulty: 3,
    anchorPrayer: 'dhuhr', slot: 'midday',
  ...
  { pack: 'foundation', title: 'Ayat al-Kursi after salah', emoji: '\u{1F6E1}\u{FE0F}', category: 'worship', difficulty: 1,
  ...
  /* --------------------------------------------------------------- quran */
  { pack: 'quran', title: 'Qur’an daily', emoji: '\u{1F4D6}', category: 'worship', difficulty: 3,
    anchorPrayer: 'fajr', slot: 'morning',
  ...
  { pack: 'quran', title: 'Morning adhkar', emoji: '\u{1F4FF}', category: 'worship', difficulty: 2,
    anchorPrayer: 'fajr', slot: 'morning',
    cue: 'After Fajr, I stay seated and read the morning adhkar.',
    tiny: 'Three tasbihat.', full: 'The full morning adhkar.',
    evidence: 'habitStacking' },

  { pack: 'quran', title: 'Evening adhkar', emoji: '\u{1F56F}\u{FE0F}', category: 'worship', difficulty: 2,
    anchorPrayer: 'asr', slot: 'evening',
    cue: 'After Asr, I read the evening adhkar before I pick up my phone.',
    tiny: 'Three tasbihat.', full: 'The full evening adhkar.',
    evidence: 'habitStacking' },

  { pack: 'quran', title: 'Istighfar ×100', emoji: '\u{1F91A}', category: 'worship', difficulty: 1,
    slot: 'anytime',
  ...
  { pack: 'quran', title: 'Salawat on the Prophet \u{FDFA}', emoji: '\u{1F338}', category: 'worship', difficulty: 1,
    slot: 'anytime',
    cue: 'Every time I unlock my phone in the evening, I send salawat once.',
    tiny: 'Ten times.', full: 'One hundred, and more on Friday.',
    evidence: 'habitStacking' },

  { pack: 'quran', title: 'Surah al-Kahf on Friday', emoji: '\u{1F54C}', category: 'worship', difficulty: 2,
  ...
  { pack: 'quran', title: 'Duha prayer', emoji: '\u{1F31E}', category: 'worship', difficulty: 3,
    slot: 'morning',
  ...
  /* ---------------------------------------------------------------- body */
  { pack: 'body', title: 'Move for 20 minutes', emoji: '\u{1F3C3}', category: 'body', difficulty: 3,
  ...
  { pack: 'body', title: 'Strength training', emoji: '\u{1F3CB}\u{FE0F}', category: 'body', difficulty: 4,
  ...
  { pack: 'body', title: 'Water on waking', emoji: '\u{1F4A6}', category: 'body', difficulty: 1,
  ...
  { pack: 'body', title: 'Morning daylight', emoji: '\u{1F506}', category: 'body', difficulty: 1,
    slot: 'morning',
  ...
  { pack: 'body', title: 'Stop eating at two-thirds', emoji: '\u{1F963}', category: 'body', difficulty: 3,
    slot: 'anytime',
  ...
  { pack: 'body', title: 'Fast Monday & Thursday', emoji: '\u{1F33E}', category: 'body', difficulty: 5,
  ...
  { pack: 'body', title: 'No food after Isha', emoji: '\u{1F37D}\u{FE0F}', category: 'body', difficulty: 3,
  ...
  /* ---------------------------------------------------------------- mind */
  { pack: 'mind', title: 'Deep work block', emoji: '\u{1F3AF}', category: 'work', difficulty: 4,
    slot: 'morning',
  ...
  { pack: 'mind', title: 'Plan tomorrow tonight', emoji: '\u{1F5D3}\u{FE0F}', category: 'work', difficulty: 2,
    slot: 'night', anchorPrayer: 'isha',
  ...
  { pack: 'mind', title: 'Read ten pages', emoji: '\u{1F4DA}', category: 'mind', difficulty: 2,
    slot: 'night',
    cue: 'The book is on my pillow. I read before I lie down, not after.',
    tiny: 'One page.', full: 'Ten pages.',
    evidence: 'environmentDesign' },

  { pack: 'mind', title: 'No phone for the first 30 minutes', emoji: '\u{1F4F5}', category: 'mind', difficulty: 3,
    slot: 'morning',
  ...
  { pack: 'mind', title: 'Brain dump', emoji: '\u{1F5D2}\u{FE0F}', category: 'mind', difficulty: 1,
    slot: 'evening',
    cue: 'When my head feels crowded, I write every open loop on paper.',
    tiny: 'Write three.', full: 'Empty the whole list.',
    evidence: 'zeigarnik' },

  { pack: 'mind', title: 'Gratitude — three specifics', emoji: '\u{2728}', category: 'mind', difficulty: 1,
    slot: 'night',
  ...
  /* --------------------------------------------------------------- night */
  { pack: 'night', title: 'Shutdown ritual', emoji: '\u{1F318}', category: 'sleep', difficulty: 3,
    slot: 'night', anchorPrayer: 'isha',
  ...
  { pack: 'night', title: 'Phone out of the bedroom', emoji: '\u{1F4F4}', category: 'sleep', difficulty: 3,
    slot: 'night',
  ...
  { pack: 'night', title: 'Surah al-Mulk before sleep', emoji: '\u{1F30C}', category: 'worship', difficulty: 2,
    slot: 'night',
  ...
  { pack: 'night', title: 'Wudu before sleeping', emoji: '\u{1F4A7}', category: 'worship', difficulty: 1,
    slot: 'night',
    cue: 'Before I lie down, I make wudu and sleep on my right side.',
    tiny: 'Make wudu.', full: 'Wudu, adhkar, right side.',
    proof: 'Bukhari 247' },

  { pack: 'night', title: 'In bed by target time', emoji: '\u{1F6CC}', category: 'sleep', difficulty: 4,
    slot: 'night',
  ...
  { pack: 'night', title: 'Fixed wake time', emoji: '\u{23F0}', category: 'sleep', difficulty: 4,
    slot: 'morning',
  ...
  /* -------------------------------------------------------------- shield */
  { pack: 'shield', title: 'Lower the gaze', emoji: '\u{1F441}\u{FE0F}', category: 'purity', difficulty: 5,
    slot: 'anytime',
  ...
  { pack: 'shield', title: 'No phone in bed', emoji: '\u{1F6CF}\u{FE0F}', category: 'purity', difficulty: 3,
    slot: 'night',
  ...
  { pack: 'shield', title: 'No phone in the bathroom', emoji: '\u{1F6AA}', category: 'purity', difficulty: 2,
    slot: 'anytime',
    cue: 'The phone stays outside the door. Every time.',
    tiny: 'Once today.', full: 'Every time, no exceptions.',
    evidence: 'environmentDesign' },

  { pack: 'shield', title: 'Check in with my accountability partner', emoji: '\u{1F91D}', category: 'purity', difficulty: 2,
  ...
  { pack: 'shield', title: 'Wudu when the urge comes', emoji: '\u{1F6BF}', category: 'purity', difficulty: 2,
    slot: 'anytime',
  ...
  { pack: 'shield', title: 'Never alone with a screen after midnight', emoji: '\u{1F303}', category: 'purity', difficulty: 4,
    slot: 'night',
